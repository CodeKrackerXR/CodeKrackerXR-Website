...
export const GPKey1Page: React.FC<{ user: any; onBack: () => void; onNavigateToHub?: (section?: string) => void; onNavigateToClues?: () => void }> = ({ user, onBack, onNavigateToHub, onNavigateToClues }) => {
  ...
  return (
    <div className="min-h-screen w-full relative bg-black flex flex-col font-sans text-white overflow-x-hidden">
      ...
      <div className="relative z-10 flex-1 w-full max-w-4xl mx-auto p-6 flex flex-col items-center text-center">
        <h1 className="text-5xl md:text-7xl font-display font-black text-white uppercase tracking-tighter border-b-4 border-vault-gold pb-4 inline-block mb-12">Key 1</h1>
